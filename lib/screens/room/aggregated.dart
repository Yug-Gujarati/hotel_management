...
class AggregatedRoom extends StatefulWidget {
  const AggregatedRoom({super.key});

  @override
  State<AggregatedRoom> createState() => _AggregatedRoomState();
}

class _AggregatedRoomState extends State<AggregatedRoom> {
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        if (room.color == const Color.fromARGB(255, 255, 229, 127)) {
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              room.roomNumber,
                              style: TextStyle(
                                color: room.color == Color.fromARGB(255, 255, 229, 127) ? Colors.black : Colors.grey[500],
                                fontSize: 12,
                                fontWeight: FontWeight.bold,
                              ),
                            ),
